...
#define N 32768 //the final number of nodes
#define I 2 // the initial number of nodes

#define MI 66 //the initial trial number
#define MF 100 //(the final trial number) - 1

#define RS 23382 //seed of the random number generator

int main()
{
	FILE *fp;
	
	double delta=sqrt(2.0);
